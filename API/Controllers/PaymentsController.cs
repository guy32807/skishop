...
public class PaymentsController(IPaymentService paymentService, IUnitOfWork unit, ILogger<PaymentCorrection> logger, IConfiguration config, IHubContext<NotificationHub> hubContext) : BaseApiController
{
    ...
    public async Task<IActionResult> StripeWebhook()
    {
        ...
        try
        {
            var stripeEvent = ConstructEvent(json);
    ...
    private Event ConstructEvent(string json)
    {
        try
        {
